...
public class InitiateWatches {
    ...
    public static void initWatches(SQLiteDatabase db) {
        ...
        db.execSQL("insert into " + DATABASE_TABLE_WATCHES + "(" + KEY_ID + ","
                ...
                + KEY_DESCRIPTION + ", "
                + KEY_IMAGE_ID + ") "
                + "values(7,'Sturhling Original Silver', '34', 'Please note personalized items are considered final sale. No returns or exchanges. We need a little more time to create your amazing, personalized piece. Please allow an additional 5-7 business days processing time for engraving and embossing orders. After processing is complete, your order will be shipped according to the selected shipping method.Please note personalized items are considered final sale. No returns or exchanges. We need a little more time to create your amazing, personalized piece. Please allow an additional 5-7 business days proPlease note personalized items are considered final sale. No returns or exchanges. We need a little more time to create your amazing, personalized piece. Please allow an additional 5-7 business days proPlease note personalized items are considered final sale. No returns or exchanges. We need a little more time to create your amazing, personalized piece. Please allow an additional 5-7 business days pro', " + R.drawable.watch7_base + ")");
        db.execSQL("insert into " + DATABASE_TABLE_WATCHES + "(" + KEY_ID + ","
                + KEY_NAME + ", "
                + KEY_PRICE + ","
                + KEY_DESCRIPTION + ", "
    ...
    public static void initWatchImages(SQLiteDatabase db) {
        db.execSQL("insert into " + DATABASE_TABLE_WATCH_IMAGES + "(" + KEY_ID + ","
                + KEY_WATCH_ID + ","
                + KEY_IMAGE_ID + ") "
